...
type
  ...
  public
    constructor Create(aProc: TProc; aCallback: TProc<String> = nil; aWorkName: string = '');
    constructor Create(aProc: TProc; aCallback: aWorkName: string = '');
  ...
  public
    ...
    procedure Enqueue(aTask: TKMWorkerThreadTaskBase); overload;
